...
(lib.Submit = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(-308,-119,614,239);
...
p.nominalBounds = new cjs.Rectangle(-262,-105,610,233);
...
p.nominalBounds = new cjs.Rectangle(-267,-12,523,391);
...
p.nominalBounds = new cjs.Rectangle(-141,-19,281,232);
...
(lib.ScrollDown = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-68,-25,0.2312,0.2545);
...
(lib.Scroll = function(mode,startPosition,loop) {
	...
	this.instance = new lib.NewProject23();
	this.instance.parent = this;
	this.instance.setTransform(-108,-34,0.3021,0.3091);
...
(lib.ScheduleCall = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(64.5,5.475);
...
(lib.Return = function(mode,startPosition,loop) {
	...
	this.instance = new lib.NewProject23();
	this.instance.parent = this;
	this.instance.setTransform(-65,-33,0.2511,0.2727);
...
(lib.RestartTutorial = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#330033").s().p("A07FKIAAqTMAp3AAAIAAKTg");
	this.shape.setTransform(134,32.975);
...
(lib.NextOrder = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.MyReferrals = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.MenuRI = function(mode,startPosition,loop) {
	...
	this.text.alpha = 0.74901961;
	this.text.parent = this;
	this.text.setTransform(47.5,-15.45);
...
(lib.MenuPlot = function(mode,startPosition,loop) {
	...
	this.text.alpha = 0.74901961;
	this.text.parent = this;
	this.text.setTransform(46.5,-14.45);
...
(lib.MenuHome = function(mode,startPosition,loop) {
	...
	this.text.alpha = 0.74901961;
	this.text.parent = this;
	this.text.setTransform(48.5,-12.95);
...
(lib.MenuClose = function(mode,startPosition,loop) {
	...
	this.text.alpha = 0.74901961;
	this.text.parent = this;
	this.text.setTransform(48.5,-11.45);
...
(lib.MenuCC = function(mode,startPosition,loop) {
	...
	this.text.alpha = 0.74901961;
	this.text.parent = this;
	this.text.setTransform(47,-18.45);
...
p.nominalBounds = new cjs.Rectangle(0,0,278,22);
...
p.nominalBounds = new cjs.Rectangle(-93,-11,277,21);
...
// stage content:
(lib.TestPatientToEvalfla = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{homepage:0,homepage2:1,Retrieve:2,patientrecord:3,patientrecord2:4,"H&P":5,Scheduling:6,otherforms:7,TO:8,TherapyOrder:9,TO3:10,STO:11,STOsig:12,STOdate:13,STOrvw:14,patientrecord3:15,referralinbox:16,referralinbox2:17,proceedtoeval1:18,proceedtoeval2:19,eval1:20,eval2:21,eval3:22,eval4:23,eval5:24,eval6:25,eval7:26,eval8:27,eval9:28,eval10:29,eval11:30,frame32:31,frame33:32,frame34:33,frame35:34,frame36:35,frame37:36,frame38:37,frame39:38,frame40:39,frame41:40,frame42:41,frame43:42,frame44:43,frame45:44,frame46:45,frame47:46,frame48:47,frame49:48,frame50:49,frame51:50,frame52:51,frame53:52,frame54:53,frame55:54,Frame56:55,frame57:56,frame58:57,frame59:58,frame60:59,frame61:60,frame62:61,frame63:62,frame64:63,frame65:64,frame66:65});
	...
	this.frame_0 = function() {
		...
		this.MenuHome.addEventListener("click", fl_ClickToGoToAndStopAtFrame_19.bind(this));
		
		function fl_ClickToGoToAndStopAtFrame_19()
		{
			this.gotoAndStop('homepage');
		}
		
		
		
		this.MenuTO.addEventListener("click", fl_ClickToGoToAndStopAtFrame_18.bind(this));
		...
		this.MenuRI.addEventListener("click", fl_ClickToGoToAndStopAtFrame_20.bind(this));
		...
		this.MenuEval.addEventListener("click", fl_ClickToGoToAndStopAtFrame_21.bind(this));
		
		function fl_ClickToGoToAndStopAtFrame_21()
		{
			this.gotoAndStop('eval1');
		}
		
		
		
		this.MenuPlot.addEventListener("click", fl_ClickToGoToAndStopAtFrame_22.bind(this));
		...
		this.MenuCC.addEventListener("click", fl_ClickToGoToAndStopAtFrame_23.bind(this));
	...
	this.frame_6 = function() {
		...
		*/
		...
		this.nextblue.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_9.bind(this));
	...
	this.frame_11 = function() {
		...
		this.next1.addEventListener("click", fl_ClickToGoToAndStopAtFrame_12.bind(this));
	...
	this.frame_54 = function() {
		...
		this.Nextforever.addEventListener("click", fl_ClickToGoToAndStopAtFrame_54.bind(this));
	...
	this.frame_62 = function() {
		...
		*/
		...
		this.nextcc1.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_11.bind(this));
	...
	this.frame_63 = function() {
		...
		*/
		...
		this.nextcc2.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_11.bind(this));
	...
	this.frame_64 = function() {
		...
		*/
		...
		this.nextcc3.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_11.bind(this));
	...
	this.frame_65 = function() {
		...
		*/
		...
		this.RestartTut.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_10.bind(this));
	...
	this.MenuClose.setTransform(334.55,305.85,1.0221,1);
	new cjs.ButtonHelper(this.MenuClose, 0, 1, 1);

	this.MenuCC = new lib.MenuCC();
	this.MenuCC.name = "MenuCC";
	this.MenuCC.parent = this;
	this.MenuCC.setTransform(333.05,680.85);
	new cjs.ButtonHelper(this.MenuCC, 0, 1, 1);

	this.MenuEval = new lib.MenuEval();
	this.MenuEval.name = "MenuEval";
	this.MenuEval.parent = this;
	this.MenuEval.setTransform(333.55,554.85);
	new cjs.ButtonHelper(this.MenuEval, 0, 1, 1);

	this.MenuRI = new lib.MenuRI();
	this.MenuRI.name = "MenuRI";
	this.MenuRI.parent = this;
	this.MenuRI.setTransform(333.55,491.85);
	new cjs.ButtonHelper(this.MenuRI, 0, 1, 1);

	this.MenuPlot = new lib.MenuPlot();
	this.MenuPlot.name = "MenuPlot";
	this.MenuPlot.parent = this;
	this.MenuPlot.setTransform(333.55,617.85);
	new cjs.ButtonHelper(this.MenuPlot, 0, 1, 1);

	this.MenuHome = new lib.MenuHome();
	this.MenuHome.name = "MenuHome";
	this.MenuHome.parent = this;
	this.MenuHome.setTransform(333.55,365.85);
	new cjs.ButtonHelper(this.MenuHome, 0, 1, 1);

	this.MenuTO = new lib.MenuTO();
	this.MenuTO.name = "MenuTO";
	this.MenuTO.parent = this;
	this.MenuTO.setTransform(374.05,436.8);
	new cjs.ButtonHelper(this.MenuTO, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.MenuTO},{t:this.MenuHome},{t:this.MenuPlot},{t:this.MenuRI},{t:this.MenuEval},{t:this.MenuCC},{t:this.MenuClose}]}).wait(66));

	// iphoneFrame
	this.Menu = new lib.homebutton();
	this.Menu.name = "Menu";
	this.Menu.parent = this;
	this.Menu.setTransform(389.5,906.4);
	new cjs.ButtonHelper(this.Menu, 0, 1, 1);

	this.instance = new lib.ipadclipartpng14transparent();
	this.instance.parent = this;
	this.instance.setTransform(1,5,0.4331,0.3906);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.Menu}]}).to({state:[{t:this.instance}]},65).wait(1));

	// Bubbles
	this.text = new cjs.Text("This is your EMR home page! Lets start by navigating to a patient. Choose 'Select a Patient' above. ", "20px 'Times'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 22;
	this.text.lineWidth = 271;
	this.text.parent = this;
	this.text.setTransform(541.05,457.55);

	this.instance_1 = new lib.NewProject22();
	this.instance_1.parent = this;
	this.instance_1.setTransform(701.95,428,0.3576,0.2308,0,0,180);

	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.NewProject22, null, new cjs.Matrix2D(1,0,0,1,-722.4,-705.6)).s().p("");
	this.shape.setTransform(297.3875,322.1375);

	this.text_1 = new cjs.Text("Uploaded documents will differ, depending on the agency. But all should have the medical history, insurance, MD, and alternative contact information. ", "20px 'Times'", "#FFFFFF");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 22;
	this.text_1.lineWidth = 288;
	this.text_1.parent = this;
	this.text_1.setTransform(533.45,487.05);

	this.nexteval1 = new lib.ScrollDown();
	this.nexteval1.name = "nexteval1";
	this.nexteval1.parent = this;
	this.nexteval1.setTransform(591,787.4);
	new cjs.ButtonHelper(this.nexteval1, 0, 1, 1);

	this.instance_2 = new lib.NewProject22();
	this.instance_2.parent = this;
	this.instance_2.setTransform(708.9,466,0.5881,0.2255,0,0,180);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1,p:{scaleX:0.3576,scaleY:0.2308,x:701.95,y:428,skewY:180}},{t:this.text,p:{scaleX:1,x:541.05,y:457.55,text:"This is your EMR home page! Lets start by navigating to a patient. Choose 'Select a Patient' above. ",font:"20px 'Times'",lineHeight:22,lineWidth:271}}]}).to({state:[{t:this.instance_1,p:{scaleX:0.3106,scaleY:0.1447,x:701,y:420,skewY:180}},{t:this.text,p:{scaleX:0.8545,x:562.7588,y:435.5,text:"Choose patient John Doe from your active patient list",font:"24px 'Times'",lineHeight:26,lineWidth:280}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3835,scaleY:0.2177,x:40,y:413,skewY:0}},{t:this.text,p:{scaleX:1,x:207,y:440.45,text:"Finally, click 'Retrieve' to open the patient's record",font:"24px 'Times'",lineHeight:26,lineWidth:213}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3835,scaleY:0.2177,x:703,y:595,skewY:180}},{t:this.text,p:{scaleX:1,x:539.45,y:613.4,text:"This is the patient record! The top section includes the patient contact information",font:"24px 'Times'",lineHeight:26,lineWidth:288}}]},1).to({state:[{t:this.shape},{t:this.instance_1,p:{scaleX:0.3835,scaleY:0.2177,x:703,y:254,skewY:180}},{t:this.text,p:{scaleX:1,x:534.45,y:268.5,text:"Uploaded documents have additional contact information, as well as the medical history of the patient. Go ahead and open this patient's H&P.",font:"20px 'Times'",lineHeight:22,lineWidth:288}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3835,scaleY:0.2177,x:703,y:468,skewY:180}},{t:this.text_1,p:{x:533.45,y:487.05,text:"Uploaded documents will differ, depending on the agency. But all should have the medical history, insurance, MD, and alternative contact information. ",lineWidth:288,font:"20px 'Times'",lineHeight:22}},{t:this.text,p:{scaleX:1,x:193.5,y:190.45,text:"",font:"20px 'Times-Roman'",lineHeight:22,lineWidth:100}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3835,scaleY:0.2177,x:40,y:412,skewY:0}},{t:this.text,p:{scaleX:1,x:208.45,y:430.35,text:"Now that we have the patient's contact information, lets give the patient a call and put in a Scheduling Therapy Order with the date they want to be seen.  ",font:"20px 'Times'",lineHeight:22,lineWidth:276}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3835,scaleY:0.2177,x:706,y:399,skewY:180}},{t:this.text,p:{scaleX:1,x:542.5,y:425.55,text:"Choose 'Other Forms' to open communication notes, therapy orders, and case conference templates.",font:"20px 'Times'",lineHeight:22,lineWidth:276}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3835,scaleY:0.1603,x:706,y:630,skewY:180}},{t:this.text,p:{scaleX:1,x:542.5,y:658.5,text:"Select 'Form Type to' bring up the note template options. ",font:"20px 'Times'",lineHeight:22,lineWidth:276}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.2987,scaleY:0.1447,x:701.85,y:636,skewY:180}},{t:this.text,p:{scaleX:1,x:577.4,y:669.5,text:"Choose Therapy Order",font:"20px 'Times'",lineHeight:22,lineWidth:276}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.2987,scaleY:0.1447,x:701.85,y:636,skewY:180}},{t:this.text,p:{scaleX:1,x:574.05,y:659.5,text:"Finally, press 'Confirm' to begin a therapy order! ",font:"20px 'Times'",lineHeight:22,lineWidth:241}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.7859,scaleY:0.2934,x:27,y:616,skewY:0}},{t:this.text_1,p:{x:362.45,y:647.4,text:"The Scheduling Therapy Order should be formatted as:\n\n'Spoke with (relationship) (name) to schedule (discipline) Evaluation for (date). (reason why family may have delayed Eval, if applicable).' \n\nGo ahead and try writing your order in the box above, then click 'next below'",lineWidth:624,font:"20px 'Times'",lineHeight:22}},{t:this.text,p:{scaleX:1,x:800.45,y:637.4,text:"",font:"20px 'Times-Roman'",lineHeight:22,lineWidth:100}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.2933,x:36,y:519,skewY:0}},{t:this.text,p:{scaleX:1,x:243,y:553.5,text:"Every communication note, therapy order, visit note, or case conference must be signed by you.  \n\nPlease click above to sign your name, then click 'next' below to continue. ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.2724,x:36,y:527,skewY:0}},{t:this.text,p:{scaleX:1,x:243,y:560.5,text:"Every communication note, therapy order, visit note, or case conference must be dated by you.  \n\nPlease click above to date the note, then click 'next' below to continue. ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.2333,x:36,y:542,skewY:0}},{t:this.text,p:{scaleX:1,x:255,y:579.5,text:"This page gives you a chance to review what you have written.  If everything looks good, press 'Finalize' to submit! ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.2672,x:36,y:529,skewY:0}},{t:this.text,p:{scaleX:1,x:243,y:548.5,text:"Okay, now that you've scheduled your Evaluation with the family, lets fast forward to 4/23/19 start the visit! \n\nClick 'My Referrals' above to access your referral inbox.",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.2359,x:706.95,y:658,skewY:180}},{t:this.text,p:{scaleX:1,x:497,y:689.45,text:"Here you can see a list of your new patients.  \n\nPress 'Select Action' under John Doe to bring up a list of actions. ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.1578,x:706.95,y:293,skewY:180}},{t:this.text,p:{scaleX:1,x:497,y:311.6,text:"Now, lets choose 'Eval' from the list to bring up the Evaluation page. ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.1578,x:706.95,y:603,skewY:180}},{t:this.text,p:{scaleX:1,x:497,y:621.55,text:"This gives you a quick snapshot of the patient. \n\nChoose Proceed to Eval. ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.2099,x:36,y:704,skewY:0}},{t:this.text,p:{scaleX:1,x:243,y:731.55,text:"You don't need to fill anything in here, just double check the date and visit type. \n\nPress 'Proceed'! ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.2099,x:36,y:360,skewY:0}},{t:this.text,p:{scaleX:1,x:243,y:387.6,text:"You are now in the Evaluation! At any time you can press 'Save & Exit' below. ",font:"20px 'Times'",lineHeight:22,lineWidth:385}},{t:this.nexteval1}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.2099,x:36,y:515,skewY:0}},{t:this.text,p:{scaleX:1,x:243,y:537.6,text:"Every note must have a subjective.  Write how the patient and/or family members feel to give important insight in to their psychosocial state and goals for therapy. ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.2099,x:705.95,y:442,skewY:180}},{t:this.text,p:{scaleX:1,x:497,y:453.6,text:"Every note must have heart rate, blood pressure, respirations, and temperature.  \n\nIf you do not already have your equipment, please start ordering it! ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.1526,x:705.95,y:474,skewY:180}},{t:this.text,p:{scaleX:1,x:497,y:493.45,text:"Lets not forget the pain vital! Pain must be addressed at every visit. Go ahead and mark that John Doe is experiencing pain. ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.1526,x:705.95,y:487,skewY:180}},{t:this.text,p:{scaleX:1,x:497,y:500.9,text:"Lets not forget the pain vital! Pain must be addressed at every visit. Go ahead and mark that John Doe is experiencing pain. ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4941,scaleY:0.2073,x:705.95,y:465,skewY:180}},{t:this.text,p:{scaleX:1,x:497,y:485.45,text:"Great job! Now options for filling the patients pain levels have populated.  If a patient has pain, you should fill these in, but for this we are going to skip them. ",font:"20px 'Times'",lineHeight:22,lineWidth:385}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.527,scaleY:0.2673,x:708,y:421,skewY:180}},{t:this.text,p:{scaleX:1,x:482.5,y:441.45,text:"For the Evaluation, you should fill out details of the patient's living situation, especially as they may relate to the plan of care (e.g. a patient with 3 steps to the kitchen may have a goal to safely go up and down 3 steps to complete ADLs)",font:"20px 'Times'",lineHeight:22,lineWidth:378}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.5881,scaleY:0.176,x:34,y:118,skewY:0}},{t:this.text,p:{scaleX:1,x:303.5,y:142.5,text:"It's appropriate to have a test to include as an objective measure (and goal) for each Evaluation.  Lets put in a Tinetti for John. ",font:"20px 'Times'",lineHeight:22,lineWidth:378}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.5881,scaleY:0.2255,x:34,y:114,skewY:0}},{t:this.text,p:{scaleX:1,x:293.5,y:123.5,text:"The test gives you easy dropdowns to select from for scoring.  Once you're done with each question, you just press 'Submit' and the system scores it for you! \nGo ahead and press 'submit.' We've filled in some answers for you. ",font:"18px 'Times'",lineHeight:20,lineWidth:378}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.5881,scaleY:0.2255,x:34,y:114,skewY:0}},{t:this.text,p:{scaleX:1,x:293.5,y:130.5,text:"Now we know that John has only scored a 9/28. Maybe we'll make a goal for him to improve his score to a reasonable 18/28 by discharge.  \n\nThat should allow him to be more independent. ",font:"18px 'Times'",lineHeight:20,lineWidth:378}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.5881,scaleY:0.2255,x:709.9,y:407,skewY:180}},{t:this.text,p:{scaleX:1,x:461.45,y:422.4,text:"For the sake of time, we're really only focusing on the vitals, SOAP, goals, and verbal orders.  \n\nBut any sections that apply to your patient should be filled out with the checkboxes, fill in the blanks, etc. to provide enough objective measures and details. ",font:"18px 'Times'",lineHeight:20,lineWidth:428}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.5881,scaleY:0.2255,x:708.9,y:465,skewY:180}},{t:this.text,p:{scaleX:1,x:456.45,y:482.4,text:"The Objective section should summarize any objective measures you have taken note of.  \n\nYour Assessment will use these objective measures to assess what the plan for the patient should be.  ",font:"18px 'Times'",lineHeight:20,lineWidth:428}}]},1).to({state:[{t:this.instance_2,p:{scaleX:0.5881,scaleY:0.2255,x:708.9,y:466}},{t:this.text_1,p:{x:456.45,y:482.4,text:"The Objective section should summarize any objective measures you have taken note of.  \n\nYour Assessment will use these objective measures to assess what the plan for the patient should be.  ",lineWidth:428,font:"18px 'Times'",lineHeight:20}},{t:this.instance_1,p:{scaleX:0.3269,scaleY:0.1264,x:701.9,y:632,skewY:180}},{t:this.text,p:{scaleX:1,x:561.5,y:651.9,text:"'Patient tolerated treatment' isn't enough for an assessment! ",font:"18px 'Times'",lineHeight:20,lineWidth:256}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3834,scaleY:0.1655,x:705.85,y:567,skewY:180}},{t:this.text_1,p:{x:456.45,y:427.4,text:"Once you've filled out the plan and any other sections of the note that apply to the patient, you are done with the SOAP portion of the Evaluation! \n\nPress 'Next' to access the next page.",lineWidth:428,font:"18px 'Times'",lineHeight:20}},{t:this.text,p:{scaleX:1,x:532,y:588,text:"Tip: The dropdown menu (where it says 'PT Evaluation') allows you to quickly jump around the note. ",font:"18px 'Times'",lineHeight:20,lineWidth:257}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4634,scaleY:0.2204,x:705.9,y:150,skewY:180}},{t:this.text,p:{scaleX:1,x:510.5,y:163.05,text:"You can either write your own exercises in to the 'additional information' box or pull up exercises in the system library.\n\nLets add a heel raise exercise.  Start by selecting the body area. ",font:"18px 'Times'",lineHeight:20,lineWidth:340}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3188,scaleY:0.1603,x:703,y:277,skewY:180}},{t:this.text,p:{scaleX:1,x:564,y:297.75,text:"Now choose 'ankle/foot' to pull up a list of ankle and foot exercises. ",font:"18px 'Times'",lineHeight:20,lineWidth:223}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3188,scaleY:0.1603,x:703,y:358,skewY:180}},{t:this.text,p:{scaleX:1,x:564,y:392.75,text:"We'll have to scroll down to find this one. ",font:"18px 'Times'",lineHeight:20,lineWidth:223}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3188,scaleY:0.1603,x:703,y:358,skewY:180}},{t:this.text,p:{scaleX:1,x:564,y:392.75,text:"Click the exercise to add it.",font:"18px 'Times'",lineHeight:20,lineWidth:223}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3188,scaleY:0.1603,x:703,y:358,skewY:180}},{t:this.text,p:{scaleX:1,x:564,y:373.75,text:"Great job!\nLet's move on to the goals on the next page. ",font:"24px 'Times'",lineHeight:26,lineWidth:223}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3917,scaleY:0.2699,x:703.95,y:569,skewY:180}},{t:this.text,p:{scaleX:1,x:537,y:593.7,text:"Goals are organized by category, with templates in each section. \n\nWe wanted to improve Mr. Doe's Tinetti from 9 to 18 by discharge, so let's open up 'Balance'.  ",font:"18px 'Times'",lineHeight:20,lineWidth:287}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3917,scaleY:0.2283,x:38,y:302,skewY:0}},{t:this.text,p:{scaleX:1,x:203,y:327.75,text:"See tinetti down at the bottom? We just need to check the box (indicating we are adding the goal to the care plan) and fill in the blanks.  ",font:"18px 'Times'",lineHeight:20,lineWidth:287}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3305,scaleY:0.1788,x:41,y:471,skewY:0}},{t:this.text,p:{scaleX:1,x:173,y:492.75,text:"There! Now we have a goal for Mr. Doe. Let's move on. ",font:"24px 'Times'",lineHeight:26,lineWidth:227}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3705,scaleY:0.2283,x:702.9,y:510,skewY:180}},{t:this.text,p:{scaleX:1,x:537,y:528.6,text:"Go ahead and skip this calendar. It's only purpose is planning out your frequency.",font:"24px 'Times'",lineHeight:26,lineWidth:227}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3705,scaleY:0.2283,x:702.9,y:510,skewY:180}},{t:this.text,p:{scaleX:1,x:537,y:528.6,text:"Every in-person visit needs a patient or POA signature. \n\nIf you lose signal, please obtain this on paper. ",font:"20px 'Times'",lineHeight:22,lineWidth:227}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3281,scaleY:0.1839,x:700.85,y:527,skewY:180}},{t:this.text,p:{scaleX:1,x:556,y:555.55,text:"Your signature is also needed. ",font:"24px 'Times'",lineHeight:26,lineWidth:227}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3281,scaleY:0.1839,x:700.85,y:527,skewY:180}},{t:this.text,p:{scaleX:1,x:556,y:546.55,text:"And of course the date (which should match the Evaluation date) ",font:"24px 'Times'",lineHeight:26,lineWidth:227}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4387,scaleY:0.2674,x:703.85,y:520,skewY:180}},{t:this.text,p:{scaleX:1,x:513,y:546.55,text:"Double check the time in and time out. Make any corrections. \n\nKeep in mind, the note time starts when you open the visit up.  ",font:"20px 'Times'",lineHeight:22,lineWidth:313}}]},1).to({state:[{t:this.instance_2,p:{scaleX:0.4387,scaleY:0.2674,x:704.85,y:503}},{t:this.text_1,p:{x:513,y:532.55,text:"Finally, we need the verbal orders! \nPer CMS guidelines, you will need to write who you spoke to at the PCP's office, when you spoke to them, and why.  ",lineWidth:313,font:"20px 'Times'",lineHeight:22}},{t:this.instance_1,p:{scaleX:0.3327,scaleY:0.1552,x:39,y:682,skewY:0}},{t:this.text,p:{scaleX:1,x:180,y:709.55,text:"Click the blue next button to see a properly filled out order. ",font:"20px 'Times'",lineHeight:22,lineWidth:271}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4387,scaleY:0.2674,x:704.85,y:503,skewY:180}},{t:this.text,p:{scaleX:1,x:517,y:532.55,text:"Since it's a Monday, the frequency called in was for 2 visits the first week. \n\nTypically from M-W it's best to put in at least 2 visits to minimize gaps in care. ",font:"20px 'Times'",lineHeight:22,lineWidth:327}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4387,scaleY:0.296,x:704.85,y:492,skewY:180}},{t:this.text,p:{scaleX:1,x:517.5,y:512.6,text:"Done! Before Finalizing a note, the system gives you an option to review.\n\nWe only added a Tinetti goal and should really go back in and put some others, though. \n\nSo let's press Save & Exit instead of Finalize.  ",font:"18px 'Times'",lineHeight:20,lineWidth:334}}]},1).to({state:[{t:this.instance_2,p:{scaleX:0.3374,scaleY:0.2647,x:702.85,y:309}},{t:this.text_1,p:{x:555.9,y:360.55,text:"Now your Evaluation is on the patient's record!   ",lineWidth:229,font:"24px 'Times'",lineHeight:26}},{t:this.instance_1,p:{scaleX:0.3374,scaleY:0.2647,x:41,y:564,skewY:0}},{t:this.text,p:{scaleX:1,x:182,y:596.55,text:"The next step is plotting your frequency and visits. \n\nTo do this, lets head back to 'My Referrals'",font:"18px 'Times'",lineHeight:20,lineWidth:265}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3892,scaleY:0.2384,x:702.8,y:563,skewY:180}},{t:this.text,p:{scaleX:1,x:537.9,y:615.95,text:"From John Doe's actions, you will select 'Keep'    ",font:"24px 'Times'",lineHeight:26,lineWidth:257}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3892,scaleY:0.2384,x:702.8,y:563,skewY:180}},{t:this.text,p:{scaleX:1,x:537.9,y:615.95,text:"From John Doe's actions, you will select 'Keep'    ",font:"24px 'Times'",lineHeight:26,lineWidth:257}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.3892,scaleY:0.2384,x:40,y:291,skewY:0}},{t:this.text,p:{scaleX:1,x:203.9,y:311,text:"This is where you plot the frequency and visits. From the side bar, you will select 2w3 and then 1w1.   ",font:"24px 'Times'",lineHeight:26,lineWidth:257}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.5139,scaleY:0.3193,x:705.8,y:348,skewY:180}},{t:this.text,p:{scaleX:1,x:487.5,y:372,text:"Great! Now we plot out a rough schedule. \n\nJohn definitely wanted to be seen on Friday after the eval, but from that point onwards, there is nothing set in stone. \n\nLets just plot a consistent schedule for now. These can always be moved within the week. ",font:"18px 'Times'",lineHeight:20,lineWidth:362}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.5985,scaleY:0.4001,x:705.75,y:306,skewY:180}},{t:this.text,p:{scaleX:1,x:449,y:343.35,text:"As we were plotting, the system wouldn't allow us to plot past 5 visits and the red message above appeared.\n\n\"You are currenttly at the max number of visits authorized.\"\n\nDid you notice John wasn't a Medicare patient? Private patients have authorizations, so you can only plot the 5 authorized visits until the rest are approved by John's insurance. \n\nGo ahead an press 'Continue'",font:"18px 'Times'",lineHeight:20,lineWidth:471}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.302,scaleY:0.2697,x:700.65,y:660,skewY:180}},{t:this.text,p:{scaleX:1,x:572,y:703.3,text:"All of the visits are standard visits since you can't yet plot your discharge, so go ahead an press confirm. ",font:"20px 'Times'",lineHeight:22,lineWidth:227}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4596,scaleY:0.2697,x:705.7,y:186,skewY:180}},{t:this.text,p:{scaleX:1,x:511,y:216.35,text:"The system takes you back to the patient's record where you can see all plotted visits. \n\nEvery patient needs a Case Conference, so lets put one in. Press 'Other Forms'. ",font:"20px 'Times'",lineHeight:22,lineWidth:347}}]},1).to({state:[]},1).to({state:[{t:this.instance_1,p:{scaleX:0.509,scaleY:0.3296,x:706.65,y:555,skewY:180}},{t:this.text,p:{scaleX:1,x:490.5,y:586.3,text:"A Case Conference asks for the Progress and Plan for the patient. You've already typed this up in your Evaluation, so there is no need to re-write it. Let's just copy and paste from your Evaluation. \n\nSelect 'View Past Notes' ",font:"20px 'Times'",lineHeight:22,lineWidth:366}}]},2).to({state:[{t:this.instance_1,p:{scaleX:0.4337,scaleY:0.2122,x:703.65,y:610,skewY:180}},{t:this.text,p:{scaleX:1,x:509.5,y:658.25,text:"Choose 'show paperwork' to open the Evaluation Notes",font:"24px 'Times'",lineHeight:26,lineWidth:302}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4337,scaleY:0.2122,x:703.65,y:457,skewY:180}},{t:this.text,p:{scaleX:1,x:523.5,y:501.3,text:"Copy your assessment and paste it in to 'Progress'",font:"24px 'Times'",lineHeight:26,lineWidth:302}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.4337,scaleY:0.2122,x:703.65,y:457,skewY:180}},{t:this.text,p:{scaleX:1,x:523.5,y:501.3,text:"Copy your verbal order and paste it in to 'Plan'",font:"24px 'Times'",lineHeight:26,lineWidth:302}}]},1).to({state:[{t:this.instance_1,p:{scaleX:0.2995,scaleY:0.1861,x:699.6,y:612,skewY:180}},{t:this.text,p:{scaleX:1,x:574,y:632.25,text:"Easy! Done! \nThe rest you know. Sign, date, and Finalize. ",font:"24px 'Times'",lineHeight:26,lineWidth:237}}]},1).to({state:[]},1).wait(1));

	// actionsbuttonsandbg
	this.Selectapatient1 = new lib.Selectapatient();
	this.Selectapatient1.name = "Selectapatient1";
	this.Selectapatient1.parent = this;
	this.Selectapatient1.setTransform(326.5,270.4,1.0275,1);
	new cjs.ButtonHelper(this.Selectapatient1, 0, 1, 2);

	this.instance_3 = new lib.ScreenShot20190425at82326AM();
	this.instance_3.parent = this;
	this.instance_3.setTransform(50,106,1.0222,1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#6600CC").ss(1,1,1).p("Aj8t7IQnElIAyRPIwJGDIqwtfg");
	this.shape_1.setTransform(544.75,525.775);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AtcAdIJguYIQnElIAyRPIwJGDg");
	this.shape_2.setTransform(544.75,525.775);

	this.instance_4 = new lib.ScreenShot20190426at112639AM();
	this.instance_4.parent = this;
	this.instance_4.setTransform(120,520);

	this.Doe = new lib.Doe();
	this.Doe.name = "Doe";
	this.Doe.parent = this;
	this.Doe.setTransform(256.6,342.55,1.0225,1);
	new cjs.ButtonHelper(this.Doe, 0, 1, 1);

	this.instance_5 = new lib.Bitmap52();
	this.instance_5.parent = this;
	this.instance_5.setTransform(46,105,1.0223,1);

	this.instance_6 = new lib.ScreenShot20190426at20710PM();
	this.instance_6.parent = this;
	this.instance_6.setTransform(67,258);

	this.retrieve1 = new lib.Retrive();
	this.retrieve1.name = "retrieve1";
	this.retrieve1.parent = this;
	this.retrieve1.setTransform(635,278);
	new cjs.ButtonHelper(this.retrieve1, 0, 1, 1);

	this.instance_7 = new lib.ScreenShot20190422at32710PM();
	this.instance_7.parent = this;
	this.instance_7.setTransform(67,780);

	this.Scrolldown1 = new lib.ScrollDown();
	this.Scrolldown1.name = "Scrolldown1";
	this.Scrolldown1.parent = this;
	this.Scrolldown1.setTransform(585,830.6);
	new cjs.ButtonHelper(this.Scrolldown1, 0, 1, 1);

	this.instance_8 = new lib.ScreenShot20190422at74532AMpngcopy();
	this.instance_8.parent = this;
	this.instance_8.setTransform(47,105);

	this.Scrolly = new lib.HP();
	this.Scrolly.name = "Scrolly";
	this.Scrolly.parent = this;
	this.Scrolly.setTransform(129.5,328.95);
	new cjs.ButtonHelper(this.Scrolly, 0, 1, 1);

	this.instance_9 = new lib.ScreenShot20190422at75450AM();
	this.instance_9.parent = this;
	this.instance_9.setTransform(49,308);

	this.instance_10 = new lib.ScreenShot20190422at75123AM();
	this.instance_10.parent = this;
	this.instance_10.setTransform(46,106);

	this.Return1 = new lib.Return();
	this.Return1.name = "Return1";
	this.Return1.parent = this;
	this.Return1.setTransform(595.95,833.5,1,1,0,0,0,23.5,-3);
	new cjs.ButtonHelper(this.Return1, 0, 1, 1);

	this.instance_11 = new lib.ScreenShot20190422at75854AM();
	this.instance_11.parent = this;
	this.instance_11.setTransform(49,105);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(2,1,1).p("AmykDINlAAIAAIHItlAAg");
	this.shape_3.setTransform(102,472.45);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AmyEEIAAoHINlAAIAAIHg");
	this.shape_4.setTransform(102,472.45);

	this.nextblue = new lib.Scroll();
	this.nextblue.name = "nextblue";
	this.nextblue.parent = this;
	this.nextblue.setTransform(583,830.5);
	new cjs.ButtonHelper(this.nextblue, 0, 1, 1);

	this.instance_12 = new lib.HP("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(129.5,328.95);

	this.otherformbutton1 = new lib.OtherForms();
	this.otherformbutton1.name = "otherformbutton1";
	this.otherformbutton1.parent = this;
	this.otherformbutton1.setTransform(256.45,685.8);
	new cjs.ButtonHelper(this.otherformbutton1, 0, 1, 1);

	this.instance_13 = new lib.ScreenShot20190422at80722AM();
	this.instance_13.parent = this;
	this.instance_13.setTransform(49,104);

	this.Selectform = new lib.Selectform();
	this.Selectform.name = "Selectform";
	this.Selectform.parent = this;
	this.Selectform.setTransform(350.45,479.9);
	new cjs.ButtonHelper(this.Selectform, 0, 1, 1);

	this.instance_14 = new lib.ScreenShot20190422at81131AM();
	this.instance_14.parent = this;
	this.instance_14.setTransform(50,105);

	this.TO = new lib.TherapyOrder();
	this.TO.name = "TO";
	this.TO.parent = this;
	this.TO.setTransform(335.9,532.85);
	new cjs.ButtonHelper(this.TO, 0, 1, 2, false, new lib.TherapyOrder(), 3);

	this.instance_15 = new lib.ScreenShot20190422at81402AM();
	this.instance_15.parent = this;
	this.instance_15.setTransform(51,105);

	this.Confirm1 = new lib.Confirm();
	this.Confirm1.name = "Confirm1";
	this.Confirm1.parent = this;
	this.Confirm1.setTransform(322,538.5);
	new cjs.ButtonHelper(this.Confirm1, 0, 1, 1);

	this.instance_16 = new lib.ScreenShot20190422at81814AM();
	this.instance_16.parent = this;
	this.instance_16.setTransform(50,106);

	this.next1 = new lib.NextOrder();
	this.next1.name = "next1";
	this.next1.parent = this;
	this.next1.setTransform(658.5,843.4);
	...
	this.SchedulingTOText.setTransform(368.7,581.95,6.0341,3.3533,0,0,0,50.1,11.1);

	this.instance_17 = new lib.ScreenShot20190422at82200AM();
	this.instance_17.parent = this;
	this.instance_17.setTransform(49,106,0.9787,1);

	this.next2 = new lib.NextOrder();
	this.next2.name = "next2";
	this.next2.parent = this;
	this.next2.setTransform(659.5,843.4);
	new cjs.ButtonHelper(this.next2, 0, 1, 1);

	this.instance_18 = new lib.Signature();
	this.instance_18.parent = this;
	this.instance_18.setTransform(335,331.95);
	new cjs.ButtonHelper(this.instance_18, 0, 1, 2, false, new lib.Signature(), 3);

	this.instance_19 = new lib.ScreenShot20190425at102527AM();
	this.instance_19.parent = this;
	this.instance_19.setTransform(50,105,0.9697,1);

	this.instance_20 = new lib.Signdate();
	this.instance_20.parent = this;
	this.instance_20.setTransform(380.5,317.05);
	new cjs.ButtonHelper(this.instance_20, 0, 1, 2, false, new lib.Signdate(), 3);

	this.next3 = new lib.NextOrder();
	this.next3.name = "next3";
	this.next3.parent = this;
	this.next3.setTransform(660.55,843.4);
	new cjs.ButtonHelper(this.next3, 0, 1, 1);

	this.instance_21 = new lib.ScreenShot20190425at103738AM();
	this.instance_21.parent = this;
	this.instance_21.setTransform(50,105,0.9758,1);

	this.finalize1 = new lib.Finalize();
	this.finalize1.name = "finalize1";
	this.finalize1.parent = this;
	this.finalize1.setTransform(645.5,845);
	new cjs.ButtonHelper(this.finalize1, 0, 1, 1);

	this.instance_22 = new lib.ScreenShot20190425at122626PM();
	this.instance_22.parent = this;
	this.instance_22.setTransform(48,105,0.9728,1);

	this.myreferrals1 = new lib.MyReferrals();
	this.myreferrals1.name = "myreferrals1";
	this.myreferrals1.parent = this;
	this.myreferrals1.setTransform(171.5,106.5);
	new cjs.ButtonHelper(this.myreferrals1, 0, 1, 1);

	this.instance_23 = new lib.ScreenShot20190425at123118PM();
	this.instance_23.parent = this;
	this.instance_23.setTransform(47,105);

	this.selectaction1 = new lib.SelectAction();
	this.selectaction1.name = "selectaction1";
	this.selectaction1.parent = this;
	this.selectaction1.setTransform(214,538.95,1,1,0,0,0,0,-2);
	new cjs.ButtonHelper(this.selectaction1, 0, 1, 2, false, new lib.SelectAction(), 3);

	this.instance_24 = new lib.ScreenShot20190425at123450PM();
	this.instance_24.parent = this;
	this.instance_24.setTransform(47,105);

	this.Eval1 = new lib.Eval();
	this.Eval1.name = "Eval1";
	this.Eval1.parent = this;
	this.Eval1.setTransform(156.5,574);
	new cjs.ButtonHelper(this.Eval1, 0, 1, 2, false, new lib.Eval(), 3);

	this.instance_25 = new lib.ScreenShot20190425at124343PM();
	this.instance_25.parent = this;
	this.instance_25.setTransform(48,106);

	this.proceedtoeval1 = new lib.Proceedtoeval();
	this.proceedtoeval1.name = "proceedtoeval1";
	this.proceedtoeval1.parent = this;
	this.proceedtoeval1.setTransform(631.95,146.55);
	new cjs.ButtonHelper(this.proceedtoeval1, 0, 1, 1);

	this.instance_26 = new lib.ScreenShot20190425at124546PM();
	this.instance_26.parent = this;
	this.instance_26.setTransform(49,104,0.9726,1.0187);

	this.proceed1 = new lib.Proceed1();
	this.proceed1.name = "proceed1";
	this.proceed1.parent = this;
	this.proceed1.setTransform(604.45,661.5);
	new cjs.ButtonHelper(this.proceed1, 0, 1, 1);

	this.instance_27 = new lib.ScreenShot20190425at125322PM();
	this.instance_27.parent = this;
	this.instance_27.setTransform(49,105);

	this.instance_28 = new lib.ScreenShot20190425at125610PM();
	this.instance_28.parent = this;
	this.instance_28.setTransform(49,106);

	this.nexteval2 = new lib.ScrollDown();
	this.nexteval2.name = "nexteval2";
	this.nexteval2.parent = this;
	this.nexteval2.setTransform(591,786.95);
	new cjs.ButtonHelper(this.nexteval2, 0, 1, 1);

	this.instance_29 = new lib.ScreenShot20190425at11727PM();
	this.instance_29.parent = this;
	this.instance_29.setTransform(49,107);

	this.nexteval3 = new lib.ScrollDown();
	this.nexteval3.name = "nexteval3";
	this.nexteval3.parent = this;
	this.nexteval3.setTransform(591,786.95);
	new cjs.ButtonHelper(this.nexteval3, 0, 1, 1);

	this.instance_30 = new lib.ScreenShot20190425at20221PM();
	this.instance_30.parent = this;
	this.instance_30.setTransform(49,108);

	this.painoption = new lib.Pain();
	this.painoption.name = "painoption";
	this.painoption.parent = this;
	this.painoption.setTransform(271.5,300.45);
	new cjs.ButtonHelper(this.painoption, 0, 1, 1);

	this.instance_31 = new lib.ScreenShot20190425at20458PM();
	this.instance_31.parent = this;
	this.instance_31.setTransform(47,109);

	this.pain2 = new lib.PainYes();
	this.pain2.name = "pain2";
	this.pain2.parent = this;
	this.pain2.setTransform(205.5,307.55);
	new cjs.ButtonHelper(this.pain2, 0, 1, 2, false, new lib.PainYes(), 3);

	this.instance_32 = new lib.ScreenShot20190425at21035PM();
	this.instance_32.parent = this;
	this.instance_32.setTransform(49,106);

	this.nexteval4 = new lib.ScrollDown();
	this.nexteval4.name = "nexteval4";
	this.nexteval4.parent = this;
	this.nexteval4.setTransform(591,787.35);
	new cjs.ButtonHelper(this.nexteval4, 0, 1, 1);

	this.instance_33 = new lib.ScreenShot20190425at21502PM();
	this.instance_33.parent = this;
	this.instance_33.setTransform(49,107);

	this.nexteval5 = new lib.ScrollDown();
	this.nexteval5.name = "nexteval5";
	this.nexteval5.parent = this;
	this.nexteval5.setTransform(590.45,786.85);
	new cjs.ButtonHelper(this.nexteval5, 0, 1, 1);

	this.instance_34 = new lib.ScreenShot20190425at21944PM();
	this.instance_34.parent = this;
	this.instance_34.setTransform(50,107);

	this.Tinetti1 = new lib.Tinetti();
	this.Tinetti1.name = "Tinetti1";
	this.Tinetti1.parent = this;
	this.Tinetti1.setTransform(95.5,361);
	new cjs.ButtonHelper(this.Tinetti1, 0, 1, 1);

	this.instance_35 = new lib.ScreenShot20190425at22400PM();
	this.instance_35.parent = this;
	this.instance_35.setTransform(50,107);

	this.Submit1 = new lib.Submit();
	this.Submit1.name = "Submit1";
	this.Submit1.parent = this;
	this.Submit1.setTransform(555.45,745);
	new cjs.ButtonHelper(this.Submit1, 0, 1, 1);

	this.instance_36 = new lib.ScreenShot20190425at22729PM();
	this.instance_36.parent = this;
	this.instance_36.setTransform(49,106);

	this.nexteval6 = new lib.ScrollDown();
	this.nexteval6.name = "nexteval6";
	this.nexteval6.parent = this;
	this.nexteval6.setTransform(596.5,784.85);
	new cjs.ButtonHelper(this.nexteval6, 0, 1, 1);

	this.instance_37 = new lib.ScreenShot20190425at22958PM();
	this.instance_37.parent = this;
	this.instance_37.setTransform(49,107);

	this.nexteval18 = new lib.ScrollDown();
	this.nexteval18.name = "nexteval18";
	this.nexteval18.parent = this;
	this.nexteval18.setTransform(596.5,784.85);
	new cjs.ButtonHelper(this.nexteval18, 0, 1, 1);

	this.instance_38 = new lib.ScreenShot20190425at23356PM();
	this.instance_38.parent = this;
	this.instance_38.setTransform(49,107);

	this.nexteval7 = new lib.ScrollDown();
	this.nexteval7.name = "nexteval7";
	this.nexteval7.parent = this;
	this.nexteval7.setTransform(597,784.85);
	new cjs.ButtonHelper(this.nexteval7, 0, 1, 1);

	this.instance_39 = new lib.ScreenShot20190425at42427PM();
	this.instance_39.parent = this;
	this.instance_39.setTransform(49,108);

	this.nexteval8 = new lib.ScrollDown();
	this.nexteval8.name = "nexteval8";
	this.nexteval8.parent = this;
	this.nexteval8.setTransform(597.5,784.85);
	new cjs.ButtonHelper(this.nexteval8, 0, 1, 1);

	this.instance_40 = new lib.ScreenShot20190425at42932PM();
	this.instance_40.parent = this;
	this.instance_40.setTransform(51,106);

	this.NextOrder3 = new lib.NextOrder();
	this.NextOrder3.name = "NextOrder3";
	this.NextOrder3.parent = this;
	this.NextOrder3.setTransform(660.5,843.4);
	new cjs.ButtonHelper(this.NextOrder3, 0, 1, 1);

	this.instance_41 = new lib.NewProject22();
	this.instance_41.parent = this;
	this.instance_41.setTransform(712.9,408,0.5881,0.2255,0,0,180);

	this.instance_42 = new lib.ScreenShot20190426at80327AM();
	this.instance_42.parent = this;
	this.instance_42.setTransform(50,99);

	this.Selectbody = new lib.SelectBodyArea();
	this.Selectbody.name = "Selectbody";
	this.Selectbody.parent = this;
	this.Selectbody.setTransform(302.5,559.45);
	new cjs.ButtonHelper(this.Selectbody, 0, 1, 1);

	this.instance_43 = new lib.ScreenShot20190426at81207AM();
	this.instance_43.parent = this;
	this.instance_43.setTransform(48,106);

	this.anklefoot = new lib.Anklefoot();
	this.anklefoot.name = "anklefoot";
	this.anklefoot.parent = this;
	this.anklefoot.setTransform(298.5,578.45);
	new cjs.ButtonHelper(this.anklefoot, 0, 1, 2, false, new lib.Anklefoot(), 3);

	this.instance_44 = new lib.ScreenShot20190426at81553AM();
	this.instance_44.parent = this;
	this.instance_44.setTransform(48,106);

	this.nexteval9 = new lib.ScrollDown();
	this.nexteval9.name = "nexteval9";
	this.nexteval9.parent = this;
	this.nexteval9.setTransform(582.5,789.85);
	new cjs.ButtonHelper(this.nexteval9, 0, 1, 1);

	this.instance_45 = new lib.ScreenShot20190426at81620AM();
	this.instance_45.parent = this;
	this.instance_45.setTransform(51,106);

	this.heelraise1 = new lib.heelraise();
	this.heelraise1.name = "heelraise1";
	this.heelraise1.parent = this;
	this.heelraise1.setTransform(376,621.9);
	new cjs.ButtonHelper(this.heelraise1, 0, 1, 1);

	this.instance_46 = new lib.ScreenShot20190426at81659AM();
	this.instance_46.parent = this;
	this.instance_46.setTransform(48,106);

	this.NextOrder4 = new lib.NextOrder();
	this.NextOrder4.name = "NextOrder4";
	this.NextOrder4.parent = this;
	this.NextOrder4.setTransform(660.5,843.4);
	new cjs.ButtonHelper(this.NextOrder4, 0, 1, 1);

	this.instance_47 = new lib.ScreenShot20190426at81720AM();
	this.instance_47.parent = this;
	this.instance_47.setTransform(49,106);

	this.balance1 = new lib.Balance();
	this.balance1.name = "balance1";
	this.balance1.parent = this;
	this.balance1.setTransform(62.5,490.4);
	new cjs.ButtonHelper(this.balance1, 0, 1, 1);

	this.instance_48 = new lib.ScreenShot20190426at82814AM();
	this.instance_48.parent = this;
	this.instance_48.setTransform(49,106);

	this.nexteval10 = new lib.Scroll();
	this.nexteval10.name = "nexteval10";
	this.nexteval10.parent = this;
	this.nexteval10.setTransform(586.5,788.85);
	new cjs.ButtonHelper(this.nexteval10, 0, 1, 1);

	this.instance_49 = new lib.ScreenShot20190426at83227AM();
	this.instance_49.parent = this;
	this.instance_49.setTransform(50,106);

	this.NextOrder5 = new lib.NextOrder();
	this.NextOrder5.name = "NextOrder5";
	this.NextOrder5.parent = this;
	this.NextOrder5.setTransform(660.5,843.5);
	new cjs.ButtonHelper(this.NextOrder5, 0, 1, 1);

	this.instance_50 = new lib.ScreenShot20190426at83737AM();
	this.instance_50.parent = this;
	this.instance_50.setTransform(50,105);

	this.NextOrder6 = new lib.NextOrder();
	this.NextOrder6.name = "NextOrder6";
	this.NextOrder6.parent = this;
	this.NextOrder6.setTransform(660.5,843.5);
	new cjs.ButtonHelper(this.NextOrder6, 0, 1, 1);

	this.instance_51 = new lib.ScreenShot20190426at84029AM();
	this.instance_51.parent = this;
	this.instance_51.setTransform(48,107);

	this.NextOrder7 = new lib.NextOrder();
	this.NextOrder7.name = "NextOrder7";
	this.NextOrder7.parent = this;
	this.NextOrder7.setTransform(660.5,843.5);
	new cjs.ButtonHelper(this.NextOrder7, 0, 1, 1);

	this.instance_52 = new lib.ScreenShot20190426at84314AM();
	this.instance_52.parent = this;
	this.instance_52.setTransform(50,106,0.9727,1);

	this.NextOrder8 = new lib.NextOrder();
	this.NextOrder8.name = "NextOrder8";
	this.NextOrder8.parent = this;
	this.NextOrder8.setTransform(660.5,843.5);
	new cjs.ButtonHelper(this.NextOrder8, 0, 1, 1);

	this.instance_53 = new lib.ScreenShot20190426at84358AM();
	this.instance_53.parent = this;
	this.instance_53.setTransform(49,106,0.9758,1);

	this.NextOrder9 = new lib.NextOrder();
	this.NextOrder9.name = "NextOrder9";
	this.NextOrder9.parent = this;
	this.NextOrder9.setTransform(660.5,843.5);
	new cjs.ButtonHelper(this.NextOrder9, 0, 1, 1);

	this.instance_54 = new lib.ScreenShot20190426at84408AM();
	this.instance_54.parent = this;
	this.instance_54.setTransform(50,105,0.9728,1);

	this.NextOrder10 = new lib.NextOrder();
	this.NextOrder10.name = "NextOrder10";
	this.NextOrder10.parent = this;
	this.NextOrder10.setTransform(660.5,843.5);
	new cjs.ButtonHelper(this.NextOrder10, 0, 1, 1);

	this.instance_55 = new lib.ScreenShot20190426at84420AM();
	this.instance_55.parent = this;
	this.instance_55.setTransform(49,106,0.9759,1);

	this.NextOrder11 = new lib.NextOrder();
	this.NextOrder11.name = "NextOrder11";
	this.NextOrder11.parent = this;
	this.NextOrder11.setTransform(660.5,843.5);
	new cjs.ButtonHelper(this.NextOrder11, 0, 1, 1);

	this.instance_56 = new lib.ScreenShot20190426at84432AM();
	this.instance_56.parent = this;
	this.instance_56.setTransform(48,105,0.9758,1);

	this.NextOrder12 = new lib.NextOrder();
	this.NextOrder12.name = "NextOrder12";
	this.NextOrder12.parent = this;
	this.NextOrder12.setTransform(660.5,843.5);
	new cjs.ButtonHelper(this.NextOrder12, 0, 1, 1);

	this.instance_57 = new lib.ScreenShot20190426at84608AM();
	this.instance_57.parent = this;
	this.instance_57.setTransform(49,105,0.9727,1);

	this.Save = new lib.Save();
	this.Save.name = "Save";
	this.Save.parent = this;
	this.Save.setTransform(48.05,826.5);
	new cjs.ButtonHelper(this.Save, 0, 1, 1);

	this.instance_58 = new lib.ScreenShot20190426at84624AM();
	this.instance_58.parent = this;
	this.instance_58.setTransform(48,107);

	this.MyReferrals3 = new lib.MyReferrals();
	this.MyReferrals3.name = "MyReferrals3";
	this.MyReferrals3.parent = this;
	this.MyReferrals3.setTransform(173,106.5);
	new cjs.ButtonHelper(this.MyReferrals3, 0, 1, 1);

	this.instance_59 = new lib.ScreenShot20190426at84743AM();
	this.instance_59.parent = this;
	this.instance_59.setTransform(48,105);

	this.SelectAction3 = new lib.SelectAction();
	this.SelectAction3.name = "SelectAction3";
	this.SelectAction3.parent = this;
	this.SelectAction3.setTransform(212,542);
	new cjs.ButtonHelper(this.SelectAction3, 0, 1, 2, false, new lib.SelectAction(), 3);

	this.instance_60 = new lib.ScreenShot20190426at84807AM();
	this.instance_60.parent = this;
	this.instance_60.setTransform(47,104);

	this.Keep3 = new lib.Keep();
	this.Keep3.name = "Keep3";
	this.Keep3.parent = this;
	this.Keep3.setTransform(63,612.4);
	new cjs.ButtonHelper(this.Keep3, 0, 1, 2, false, new lib.Keep(), 3);

	this.instance_61 = new lib.ScreenShot20190426at91428AM();
	this.instance_61.parent = this;
	this.instance_61.setTransform(49,104);

	this.Nextplot1 = new lib.Scroll();
	this.Nextplot1.name = "Nextplot1";
	this.Nextplot1.parent = this;
	this.Nextplot1.setTransform(579.5,819.85);
	new cjs.ButtonHelper(this.Nextplot1, 0, 1, 1);

	this.instance_62 = new lib.ScreenShot20190426at91653AM();
	this.instance_62.parent = this;
	this.instance_62.setTransform(48,105);

	this.Nextforever = new lib.ScrollDown();
	this.Nextforever.name = "Nextforever";
	this.Nextforever.parent = this;
	this.Nextforever.setTransform(575.5,821.9);
	new cjs.ButtonHelper(this.Nextforever, 0, 1, 1);

	this.instance_63 = new lib.ScreenShot20190426at91942AM();
	this.instance_63.parent = this;
	this.instance_63.setTransform(49,106);

	this.nextplot2 = new lib.Scroll();
	this.nextplot2.name = "nextplot2";
	this.nextplot2.parent = this;
	this.nextplot2.setTransform(584.5,818.85);
	new cjs.ButtonHelper(this.nextplot2, 0, 1, 1);

	this.instance_64 = new lib.Continue1();
	this.instance_64.parent = this;
	this.instance_64.setTransform(578.5,234.45);
	new cjs.ButtonHelper(this.instance_64, 0, 1, 1);

	this.instance_65 = new lib.ScreenShot20190426at92256AM();
	this.instance_65.parent = this;
	this.instance_65.setTransform(49,106);

	this.Confirm6 = new lib.Confirm();
	this.Confirm6.name = "Confirm6";
	this.Confirm6.parent = this;
	this.Confirm6.setTransform(324,746.4);
	new cjs.ButtonHelper(this.Confirm6, 0, 1, 1);

	this.instance_66 = new lib.ScreenShot20190426at92713AM();
	this.instance_66.parent = this;
	this.instance_66.setTransform(48,106);

	this.OtherForms3 = new lib.OtherForms();
	this.OtherForms3.name = "OtherForms3";
	this.OtherForms3.parent = this;
	this.OtherForms3.setTransform(257.5,401.95);
	new cjs.ButtonHelper(this.OtherForms3, 0, 1, 1);

	this.instance_67 = new lib.ScreenShot20190426at93310AM();
	this.instance_67.parent = this;
	this.instance_67.setTransform(49,105);

	this.SelectForm3 = new lib.Selectform();
	this.SelectForm3.name = "SelectForm3";
	this.SelectForm3.parent = this;
	this.SelectForm3.setTransform(351,481.95);
	new cjs.ButtonHelper(this.SelectForm3, 0, 1, 1);

	this.instance_68 = new lib.ScreenShot20190426at93533AM();
	this.instance_68.parent = this;
	this.instance_68.setTransform(48,105);

	this.CaseConference3 = new lib.CaseConference();
	this.CaseConference3.name = "CaseConference3";
	this.CaseConference3.parent = this;
	this.CaseConference3.setTransform(261.5,554.95);
	new cjs.ButtonHelper(this.CaseConference3, 0, 1, 2, false, new lib.CaseConference(), 3);

	this.instance_69 = new lib.ScreenShot20190426at93545AM();
	this.instance_69.parent = this;
	this.instance_69.setTransform(47,106);

	this.Viewpastnotes1 = new lib.Viewpastnotes();
	this.Viewpastnotes1.name = "Viewpastnotes1";
	this.Viewpastnotes1.parent = this;
	this.Viewpastnotes1.setTransform(135,826.85);
	new cjs.ButtonHelper(this.Viewpastnotes1, 0, 1, 1);

	this.instance_70 = new lib.ScreenShot20190426at93628AM();
	this.instance_70.parent = this;
	this.instance_70.setTransform(49,105,0.9728,1);

	this.Showpaperwork = new lib.Showpaperwork();
	this.Showpaperwork.name = "Showpaperwork";
	this.Showpaperwork.parent = this;
	this.Showpaperwork.setTransform(377.5,541.4);
	new cjs.ButtonHelper(this.Showpaperwork, 0, 1, 1);

	this.instance_71 = new lib.ScreenShot20190426at94206AM();
	this.instance_71.parent = this;
	this.instance_71.setTransform(166,414);

	this.nextcc1 = new lib.Scroll();
	this.nextcc1.name = "nextcc1";
	this.nextcc1.parent = this;
	this.nextcc1.setTransform(581.5,165.9);
	new cjs.ButtonHelper(this.nextcc1, 0, 1, 1);

	this.instance_72 = new lib.ScreenShot20190426at94317AM();
	this.instance_72.parent = this;
	this.instance_72.setTransform(49,105,1,1.0267);

	this.nextcc2 = new lib.Scroll();
	this.nextcc2.name = "nextcc2";
	this.nextcc2.parent = this;
	this.nextcc2.setTransform(581.5,162.9);
	new cjs.ButtonHelper(this.nextcc2, 0, 1, 1);

	this.instance_73 = new lib.ScreenShot20190426at94336AM();
	this.instance_73.parent = this;
	this.instance_73.setTransform(49,107,1,1.0108);

	this.nextcc3 = new lib.Scroll();
	this.nextcc3.name = "nextcc3";
	this.nextcc3.parent = this;
	this.nextcc3.setTransform(586.5,788.25);
	new cjs.ButtonHelper(this.nextcc3, 0, 1, 1);

	this.instance_74 = new lib.ScreenShot20190426at95001AM();
	this.instance_74.parent = this;
	this.instance_74.setTransform(49,105,0.9788,1);

	this.ScheduleCall = new lib.ScheduleCall();
	this.ScheduleCall.name = "ScheduleCall";
	this.ScheduleCall.parent = this;
	this.ScheduleCall.setTransform(298.5,657.35);
	new cjs.ButtonHelper(this.ScheduleCall, 0, 1, 1);

	this.RestartTut = new lib.RestartTutorial();
	this.RestartTut.name = "RestartTut";
	this.RestartTut.parent = this;
	this.RestartTut.setTransform(228.5,534.65);
	new cjs.ButtonHelper(this.RestartTut, 0, 1, 1);

	this.instance_75 = new lib.Lifespan();
	this.instance_75.parent = this;
	this.instance_75.setTransform(358.5,222.5,1.7795,1.7237);
	...
	this.text_2.setTransform(362,385.45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.instance_3},{t:this.Selectapatient1}]}).to({state:[{t:this.instance_5},{t:this.Doe},{t:this.instance_4}]},1).to({state:[{t:this.instance_7},{t:this.instance_3},{t:this.retrieve1,p:{x:635,y:278}},{t:this.instance_6}]},1).to({state:[{t:this.instance_8},{t:this.Scrolldown1}]},1).to({state:[{t:this.instance_10,p:{x:46}},{t:this.instance_9},{t:this.Scrolly}]},1).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.instance_11},{t:this.Return1}]},1).to({state:[{t:this.instance_10,p:{x:50}},{t:this.instance_9},{t:this.instance_12},{t:this.nextblue}]},1).to({state:[{t:this.instance_13},{t:this.otherformbutton1}]},1).to({state:[{t:this.instance_14},{t:this.Selectform}]},1).to({state:[{t:this.instance_15},{t:this.TO}]},1).to({state:[{t:this.instance_16},{t:this.Confirm1}]},1).to({state:[{t:this.retrieve1,p:{x:48,y:-147.4}},{t:this.instance_17},{t:this.SchedulingTOText},{t:this.next1}]},1).to({state:[{t:this.instance_19},{t:this.instance_18},{t:this.next2}]},1).to({state:[{t:this.instance_21},{t:this.next3},{t:this.instance_20}]},1).to({state:[{t:this.instance_22},{t:this.finalize1}]},1).to({state:[{t:this.instance_23},{t:this.myreferrals1}]},1).to({state:[{t:this.instance_24},{t:this.selectaction1}]},1).to({state:[{t:this.instance_25},{t:this.Eval1}]},1).to({state:[{t:this.instance_26},{t:this.proceedtoeval1}]},1).to({state:[{t:this.instance_27},{t:this.proceed1}]},1).to({state:[{t:this.instance_28}]},1).to({state:[{t:this.instance_29},{t:this.nexteval2}]},1).to({state:[{t:this.instance_30},{t:this.nexteval3}]},1).to({state:[{t:this.instance_31,p:{x:47,y:109}},{t:this.painoption}]},1).to({state:[{t:this.instance_31,p:{x:48,y:107}},{t:this.painoption},{t:this.instance_32},{t:this.pain2}]},1).to({state:[{t:this.instance_33},{t:this.nexteval4}]},1).to({state:[{t:this.instance_34},{t:this.nexteval5}]},1).to({state:[{t:this.instance_35},{t:this.Tinetti1}]},1).to({state:[{t:this.instance_36},{t:this.Submit1}]},1).to({state:[{t:this.instance_37},{t:this.nexteval6,p:{x:596.5,y:784.85}}]},1).to({state:[{t:this.instance_38},{t:this.nexteval18},{t:this.nexteval6,p:{x:448.5,y:488.9}}]},1).to({state:[{t:this.nexteval6,p:{x:596.5,y:784.85}},{t:this.instance_39},{t:this.nexteval7}]},1).to({state:[{t:this.instance_40},{t:this.nexteval8}]},1).to({state:[{t:this.instance_42},{t:this.instance_41},{t:this.NextOrder3}]},1).to({state:[{t:this.instance_43},{t:this.Selectbody}]},1).to({state:[{t:this.instance_44},{t:this.anklefoot}]},1).to({state:[{t:this.instance_45},{t:this.nexteval9}]},1).to({state:[{t:this.instance_46},{t:this.heelraise1}]},1).to({state:[{t:this.instance_47},{t:this.NextOrder4}]},1).to({state:[{t:this.instance_48},{t:this.balance1}]},1).to({state:[{t:this.instance_49},{t:this.nexteval10}]},1).to({state:[{t:this.instance_50},{t:this.NextOrder5}]},1).to({state:[{t:this.instance_51},{t:this.NextOrder6}]},1).to({state:[{t:this.instance_52},{t:this.NextOrder7}]},1).to({state:[{t:this.instance_53},{t:this.NextOrder8}]},1).to({state:[{t:this.instance_54},{t:this.NextOrder9}]},1).to({state:[{t:this.instance_55},{t:this.NextOrder10}]},1).to({state:[{t:this.instance_56},{t:this.NextOrder11}]},1).to({state:[{t:this.instance_57},{t:this.NextOrder12}]},1).to({state:[{t:this.instance_58},{t:this.Save}]},1).to({state:[{t:this.instance_59},{t:this.MyReferrals3}]},1).to({state:[{t:this.instance_60},{t:this.SelectAction3}]},1).to({state:[{t:this.instance_61},{t:this.Keep3}]},1).to({state:[{t:this.instance_62},{t:this.Nextplot1,p:{x:579.5,y:819.85}}]},1).to({state:[{t:this.instance_63},{t:this.Nextplot1,p:{x:609.15,y:906.4}},{t:this.Nextforever}]},1).to({state:[{t:this.instance_65},{t:this.instance_64},{t:this.nextplot2}]},1).to({state:[{t:this.instance_66},{t:this.Confirm6}]},1).to({state:[{t:this.instance_67},{t:this.OtherForms3}]},1).to({state:[{t:this.instance_68},{t:this.SelectForm3}]},1).to({state:[{t:this.instance_69},{t:this.CaseConference3}]},1).to({state:[{t:this.instance_70},{t:this.Viewpastnotes1}]},1).to({state:[{t:this.instance_70},{t:this.instance_71},{t:this.Showpaperwork}]},1).to({state:[{t:this.instance_72},{t:this.nextcc1}]},1).to({state:[{t:this.instance_73},{t:this.nextcc2}]},1).to({state:[{t:this.instance_74},{t:this.nextcc3}]},1).to({state:[{t:this.text_2},{t:this.instance_75},{t:this.RestartTut},{t:this.ScheduleCall}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(371,315.6,481.5,655.9);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/ScreenShot20190425at20458PM.png", id:"ScreenShot20190425at20458PM"},
